...
**추가 기능**
- 상단 바 동적 스크롤: Collapsing Toolbar 레이아웃을 AppBar 하위에 선언하여 앱바가 접힐 때 다양한 설정 가능
...
- **Card**
  - 정보를 담는 컨테이너 UI 컴포넌트
  - 그림자, 테두리, 둥근 모서리 등으로 시각적 콘텐츠 구성
- Card 내부에서 **Column** 또는 **Row**를 사용해 이미지, 텍스트 등 체계적 배치
- **InfoCard**
  - Card 기반으로 앱 특정 데이터에 맞게 스타일링된 재사용 컴포넌트
